...
class MarketConnector:
    ...
    def __init__(self, config: Dict[str, str]):
        ...
        Args:
            config: Dictionary containing:
                ...
                - KALSHI_PRIVATE_KEY_DIR: Directory containing the private key file
        """
    ...
    def _find_private_key(self, directory: str) -> str:
        """Find the private key file in the given directory."""
        ...
        # Look for .pem, .txt, or any file containing private key
    ...
    def _sign_request(self, method: str, path: str) -> Dict[str, str]:
        ...
        Args:
            ...
            path: API path (without query parameters, relative to BASE_PATH)

        Returns:
            Dictionary of required authentication headers
        """
        timestamp = str(int(time.time() * 1000))
        # Must sign the FULL path including /trade-api/v2
        ...
        signature = private_key.sign(
            ...
            padding.PSS(
                ...
                salt_length=padding.PSS.DIGEST_LENGTH  # Must be 32 (SHA256 digest length)
            ),
            hashes.SHA256()
        )
    ...
    def _get(self, path: str, params: Optional[Dict] = None, debug: bool = False) -> Dict[str, Any]:
        ...
        if debug:
            ...
            print(f"Headers: KALSHI-ACCESS-KEY={headers['KALSHI-ACCESS-KEY'][:8]}...")
            print(f"Headers: KALSHI-ACCESS-TIMESTAMP={headers['KALSHI-ACCESS-TIMESTAMP']}")
            print(f"Headers: KALSHI-ACCESS-SIGNATURE={headers['KALSHI-ACCESS-SIGNATURE'][:20]}...")
    ...
    def place_order(self,
        ...
        Args:
            ...
            expiration_ts: Order expiration timestamp (ms)
